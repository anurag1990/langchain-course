...
def get_product_price(product: str) -> float:
    ...
    prices = {"laptop": 1299.99, "headphones": 199.99, "keyboard": 79.99} 
...
def apply_discount(price: float, discount_tier: str) -> float:
    ...
    print(f"    >> Executing apply_discount(product=  '{price}', discount= {discount_tier})")
...
def run_agent(question: str):
    ...
    scratchpad = "" # To accumulate the Thought/Action/Observation history
